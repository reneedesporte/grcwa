...
ep0 = 1.0  # dielectric for layer 1 (uniform)
epp = 4.0  # dielectric for patterned layer
epbkg = 1.0  # dielectric for holes in the patterned layer
epN = 1.0  # dielectric for layer N (uniform)
...
u0 = np.linspace(0, 1.0, Nx)
v0 = np.linspace(0, 1.0, Ny)
